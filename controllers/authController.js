...
exports.forgotPassword = catchAsync(async(req, res, next) => {
    ...
    if (!user) {
        return next(new AppError('The provided email address isn`t registered!', 404))
    }
    ...
    try {
        ...
        return next(new AppError(`There was an error sending email. Try again later! ${err}!`, 500));
    }
})
